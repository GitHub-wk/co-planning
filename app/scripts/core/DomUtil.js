...
var DomUtil = {
	...
	setStyle: function ( el,style, array ) {
     ...
     */
    appendChild:function(fatherEle,childEle){
    	if(childEle instanceof Array){
    		Util.forEach(childEle,function(child){
    			fatherEle.appendChild(child);
    		});
    	}
    	else{fatherEle.appendChild(childEle);}
    },
...
events.forEach( function ( event ) {
	...
	UI.Element.prototype[ method ] = function ( callback ) {
		...
		this.dom.addEventListener( event.toLowerCase(), Util.bind(callback,this), false );
